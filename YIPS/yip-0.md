...
YIP stands for YFII Improvement Proposal, it has been adapted from the SIP (Synthetix Improvement Proposal). The purpose of this process is to ensure changes to YFII are transparent and well governed. An YIP is a design document providing information to the YFII community about a proposed change to the system. The author is responsible for building consensus within the community and documenting dissenting opinions.

## YIP Rationale

We intend YIPs to be the primary mechanisms for proposing new features, collecting community input on an issue, and for documenting the design decisions for changes to YFII. Because they are maintained as text files in a versioned repository, their revision history is the historical record of the feature proposal.
...
Parties involved in the process are the *author*, the [*YIP editors*](#yip-editors), and the YFII community.

:warning: Before you begin, vet your idea, this will save you time. Ask the YFII community first if an idea is original to avoid wasting time on something that will be rejected based on prior research (searching the Internet does not always do the trick). It also helps to make sure the idea is applicable to the entire community and not just the author. Just because an idea sounds good to the author does not mean it will have the intend effect. The appropriate public forum to gauge interest around your YIP is [the unofficial YFII Discord] or [the unofficial YFII Telegram].
...
* **Work in progress (WIP)** -- Once the champion has asked the YFII community whether an idea has any chance of support, they will write a draft YIP as a [pull request]. Consider including an implementation if this will aid people in studying the YIP.
...
- Motivation (*optional) - The motivation is critical for YIPs that want to change YFII. It should clearly explain why the existing specification is inadequate to address the problem that the YIP solves. YIP submissions without sufficient motivation may be rejected outright.
...
[the unofficial YFII Discord]: https://discord.com/invite/3AGgWxy
[the unofficial YFII Telegram]: https://t.me/yearnfinance
